    ...
    <div className="max-w-[1400px] mx-auto">
      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
          <TabsList className="bg-white/50 backdrop-blur-sm border border-slate-200/60 p-1 rounded-xl grid grid-cols-5 w-full h-auto">
            <TabsTrigger
              value="api-keys"
              className="rounded-lg data-[state=active]:bg-slate-900 data-[state=active]:text-white data-[state=active]:shadow-md transition-all duration-200 flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 sm:py-2.5 text-slate-600 data-[state=inactive]:hover:bg-slate-100"
            >
